...
/**
 * Created by dengyu on 2018/01/11
 *
 * @author fengyiming
 *         随机产生红包：金额正态分布
 *
...
public class RedPacket {
    ...
    public static void main(String[] args) {
        ...
        //5000 元  180个红包   均值3  方差为1
        List<BigDecimal> allHotPacket = getAllHotPacket(5000d, 180d, 3d, 1d);
        ...
        System.out.println("手气最差为：第" + minIndex + "个红包，金额为：" + min);
    }
